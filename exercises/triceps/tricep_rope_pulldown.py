"""Tricep Rope Pulldown exercise tracker"""
from utils.base_exercise import BaseExercise


class TricepRopePulldownCoordinates(BaseExercise):
    ...
    def process_coordinates(self, coordinates):
        """
        Process coordinates for tricep rope pulldown
        ...
        if angle > self.max_angle_threshold:
            ...
            if self.stage != "down":
                ...
                current_stage = "down"
                self.counter += 1
                feedback = "Perfect extension! Return"
            else:
                feedback = "Triceps fully contracted"
        else:
            feedback = "Pull rope down"
