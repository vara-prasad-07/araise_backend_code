"""Romanian Deadlift (RDL) exercise tracker"""
from utils.base_exercise import BaseExercise


class RomanianDeadliftCoordinates(BaseExercise):
    def __init__(self, user_id=None):
        super().__init__(user_id)
        self.min_angle_threshold = 100
        self.max_angle_threshold = 170
        
    def process_coordinates(self, coordinates):
        """
        Process coordinates for Romanian deadlift
