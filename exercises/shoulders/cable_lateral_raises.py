"""Cable Lateral Raises exercise tracker"""
from utils.base_exercise import BaseExercise


class CableLateralRaisesCoordinates(BaseExercise):
    ...
    def process_coordinates(self, coordinates):
        """
        Process coordinates for cable lateral raises
