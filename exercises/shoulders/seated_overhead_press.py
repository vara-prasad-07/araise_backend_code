"""Seated Overhead Press exercise tracker"""
from utils.base_exercise import BaseExercise


class SeatedOverheadPressCoordinates(BaseExercise):
    ...
    def process_coordinates(self, coordinates):
        """
        Process coordinates for seated overhead press
        ...
        if angle > self.max_angle_threshold:
            ...
            if self.stage != "down":
                ...
                current_stage = "down"
                self.counter += 1
                feedback = "Excellent! Drive up"
            else:
                feedback = "Weights at shoulders"
        else:
