"""Lat Pulldown exercise tracker"""
from utils.base_exercise import BaseExercise


class LatPulldownCoordinates(BaseExercise):
    ...
    def process_coordinates(self, coordinates):
        """
        Process coordinates for lat pulldown
        ...
        if angle > self.max_angle_threshold:
            ...
            if self.stage != "down":
                ...
                current_stage = "down"
                self.counter += 1
                feedback = "Great rep! Release up"
            else:
                feedback = "Lats fully engaged"
        else:
            feedback = "Pull bar down"
