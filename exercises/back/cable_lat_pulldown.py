"""Cable Lat Pulldown exercise tracker"""
from utils.base_exercise import BaseExercise


class CableLatPulldownCoordinates(BaseExercise):
    ...
    def process_coordinates(self, coordinates):
        """
        Process coordinates for cable lat pulldown
        ...
        if angle > self.max_angle_threshold:
            ...
            if self.stage != "down":
                ...
                current_stage = "down"
                self.counter += 1
                feedback = "Perfect! Release back up"
            else:
                feedback = "Squeeze your lats"
        else:
            feedback = "Pull to chest"
