"""Incline Dumbbell Press exercise tracker"""
from utils.base_exercise import BaseExercise


class InclineDumbbellPressCoordinates(BaseExercise):
    ...
    def process_coordinates(self, coordinates):
        """
        Process coordinates for incline dumbbell press
